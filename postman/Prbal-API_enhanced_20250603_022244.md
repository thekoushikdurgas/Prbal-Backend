...
## Table of Contents
- [❌ Ensure 'avatar.jpg' exists in the directory where you run curl](#ensure-avatarjpg-exists-in-the-directory-where-you-run-curl)
...
- [✅Authentication](#authentication)(L-141)
  - [✅User Registration](#user-registration)(L-143)
    - [✅Generic User Registration (Defaults to Customer Type)](#generic-user-registration-defaults-to-customer-type)(L-145)
    - [✅Customer Specific Registration](#customer-specific-registration)(L-230)
    - [✅Provider Specific Registration](#provider-specific-registration)(L-336)
    - [✅Admin Specific Registration](#admin-specific-registration)(L-455)
  - [✅User Logout](#user-logout)(L-537)
  - [✅Access Token Management](#access-token-management)(L-585)
    - [✅List User's Access Tokens](#list-users-access-tokens)(L-588)
    - [✅Revoke Specific Access Token](#revoke-specific-access-token)(L-640)
    - [✅Refresh JWT Access Token](#refresh-jwt-access-token)(L-686)
- [✅User Management](#user-management)(L-729)
  - [✅Generic User Endpoints](#generic-user-endpoints)(L-732)
    - [✅Manage Own Profile](#manage-own-profile)(L-735)
    - [✅Upload/Change Own Avatar](#uploadchange-own-avatar)(L-838)
    - [✅Deactivate Own Account](#deactivate-own-account)(L-904)
    - [✅Change Own Password](#change-own-password)(L-972)
  - [✅Customer Specific Endpoints](#customer-specific-endpoints)(L-1035)
    - [✅Manage Own Customer Profile](#manage-own-customer-profile)(L-1038)
  - [❌Provider Specific Endpoints](#provider-specific-endpoints)(L-1171)
    - [❌Manage Own Provider Profile](#manage-own-provider-profile)(L-1175)
  - [❌Admin Specific Endpoints (Profile)](#admin-specific-endpoints-profile)(L-1183)
    - [❌Manage Own Admin Profile](#manage-own-admin-profile)(L-1188)
  - [❌User Search](#user-search)(L-1196)
    - [❌General User Search](#general-user-search)(L-1201)
    - [❌User Search by Phone Number](#user-search-by-phone-number)(L-1206)
- [❌Services & Service Requests](#services--service-requests)(L-1214)
  - [❌Public Service & Category Endpoints](#public-service--category-endpoints)(L-1219)
  - [❌Provider Service Management](#provider-service-management)(L-1224)
  - [❌Public Service Request Endpoints](#public-service-request-endpoints)(L-1229)
  - [❌Service Requests (Customer)](#service-requests-customer)(L-1234)
  - [❌Service Requests (Admin)](#service-requests-admin)(L-1239)
- [❌Products](#products)(L-1247)
  - [❌Product Categories](#product-categories)(L-1252) 
  - [❌Products (Individual)](#products-individual)(L-1257)
- [❌Bids](#bids)(L-1265)
  - [❌Provider Bidding Actions](#provider-bidding-actions)(L-1270)
  - [❌Bids - Customer View](#bids---customer-view)(L-1275)
  - [❌Bids - Admin View](#bids---admin-view)(L-1280)
- [❌Bookings](#bookings)(L-1288)
  - [❌Create Booking](#create-booking)(L-1293)
  - [❌View Booking Details](#view-booking-details)(L-1298)
  - [❌Update Booking Status](#update-booking-status)(L-1303)
  - [❌List Customer Bookings](#list-customer-bookings)(L-1308)
  - [❌List Provider Bookings](#list-provider-bookings)(L-1313)
  - [❌List Admin Bookings](#list-admin-bookings)(L-1318)
- [❌Calendar Integration](#calendar-integration)(L-1326)
- [❌Payment Processing](#payment-processing)(L-1333)
  - [❌Create Payment Intent](#create-payment-intent)(L-1338)
  - [❌Confirm Payment](#confirm-payment)(L-1343)
  - [❌Retrieve Payment Details](#retrieve-payment-details)(L-1348)
  - [❌List Payments (Customer/Provider/Admin)](#list-payments-customerprovideradmin)(L-1353)
  - [❌Issue Refund (Admin)](#issue-refund-admin)(L-1358)
  - [❌Payment Gateway Accounts (Provider)](#payment-gateway-accounts-provider)(L-1366)
    - [❌Link Payment Gateway Account](#link-payment-gateway-account)(L-1371)
    - [❌View Payment Gateway Account Details](#view-payment-gateway-account-details)(L-1376)
    - [❌Update Payment Gateway Account](#update-payment-gateway-account)(L-1381)
    - [❌Remove Payment Gateway Account](#remove-payment-gateway-account)(L-1386)
  - [❌Payouts (Provider/Admin)](#payouts-provideradmin)(L-1394)
    - [❌Request Payout (Provider)](#request-payout-provider)(L-1399)
    - [❌View Payout History (Provider/Admin)](#view-payout-history-provideradmin)(L-1404)
    - [❌Process Payouts (Admin)](#process-payouts-admin)(L-1409)
    - [❌View Payout Settings (Provider/Admin)](#view-payout-settings-provideradmin)(L-1414)
- [❌Messaging](#messaging)(L-1419)
  - [❌Message Threads](#message-threads)(L-1424)
    - [❌Create Message Thread](#create-message-thread)(L-1429)
    - [❌List User Message Threads](#list-user-message-threads)(L-1434)
    - [❌View Message Thread Details](#view-message-thread-details)(L-1439)
    - [❌Archive Message Thread](#archive-message-thread)(L-1444)
    - [❌Mark Thread as Read/Unread](#mark-thread-as-readunread)(L-1449)
  - [❌Individual Messages](#individual-messages)(L-1454)
    - [❌Send Message in Thread](#send-message-in-thread)(L-1459)
    - [❌List Messages in Thread](#list-messages-in-thread)(L-1464)
    - [❌Edit Message](#edit-message)(L-1469)
- [❌Notifications (HTTP)](#notifications-http)(L-1395)
  - [❌List User Notifications](#list-user-notifications)(L-1398)
  - [❌Mark Notification as Read](#mark-notification-as-read)(L-1401)
  - [❌Mark All Notifications as Read](#mark-all-notifications-as-read)(L-1404)
  - [❌Delete Notification](#delete-notification)(L-1407)
  - [❌Notification Settings](#notification-settings)(L-1410)
    - [❌Get Notification Settings](#get-notification-settings)(L-1413)
    - [❌Update Notification Settings](#update-notification-settings)(L-1416)
- [❌AI Suggestions & Feedback](#ai-suggestions--feedback)(L-1423)
  - [❌AI Suggestions](#ai-suggestions)(L-1428)
    - [❌Get AI Suggestions for Service Request](#get-ai-suggestions-for-service-request)(L-1433)
    - [❌Get AI Suggestions for Pricing](#get-ai-suggestions-for-pricing)(L-1438)
    - [❌Get AI Suggestions for Descriptions](#get-ai-suggestions-for-descriptions)(L-1443)
  - [❌AI Feedback Logs](#ai-feedback-logs)(L-1448)
    - [❌Submit Feedback on AI Suggestion](#submit-feedback-on-ai-suggestion)(L-1453)
    - [❌List AI Feedback Logs (Admin)](#list-ai-feedback-logs-admin)(L-1458)
- [❌Verifications (User Identity, etc.)](#verifications-user-identity-etc)(L-1465)
  - [❌Submit Verification Document](#submit-verification-document)(L-1470)
  - [❌Check Verification Status](#check-verification-status)(L-1475)
  - [❌Admin Verification Actions](#admin-verification-actions)(L-1480)
    - [❌List Pending Verifications (Admin)](#list-pending-verifications-admin)(L-1485)
    - [❌Approve/Reject Verification (Admin)](#approvereject-verification-admin)(L-1490)
- [❌Reviews](#reviews)(L-1497)
  - [❌Submit Review for a Service/Provider](#submit-review-for-a-serviceprovider)(L-1502)
  - [❌View Reviews for a Service/Provider](#view-reviews-for-a-serviceprovider)(L-1507)
  - [❌View Reviews by a User](#view-reviews-by-a-user)(L-1512)
  - [❌Update Own Review](#update-own-review)(L-1517)
  - [❌Delete Own Review](#delete-own-review)(L-1522)
  - [❌Admin Review Management](#admin-review-management)(L-1527)
    - [❌List All Reviews (Admin)](#list-all-reviews-admin)(L-1532)
    - [❌Moderate/Delete Review (Admin)](#moderatedelete-review-admin)(L-1537)
- [❌Sync (Offline Functionality)](#sync-offline-functionality)(L-1544)
  - [❌Get Data for Offline Sync](#get-data-for-offline-sync)(L-1549)
  - [❌Push Offline Changes to Server](#push-offline-changes-to-server)(L-1554)
  - [❌Get Sync Status](#get-sync-status)(L-1559)
- [❌Analytics & Admin Management](#analytics--admin-management)(L-1566)
  - [❌Analytics Reports](#analytics-reports)(L-1571)
    - [❌Generate User Activity Report](#generate-user-activity-report)(L-1576)
    - [❌Generate Service Popularity Report](#generate-service-popularity-report)(L-1581)
    - [❌Generate Financial Report](#generate-financial-report)(L-1586)
    - [❌View System Performance Metrics](#view-system-performance-metrics)(L-1591)
  - [❌Admin User Management](#admin-user-management)(L-1596)
    - [❌List All Users (Admin)](#list-all-users-admin)(L-1601)
    - [❌View User Details (Admin)](#view-user-details-admin)(L-1606)
    - [❌Activate/Deactivate User (Admin)](#activatedeactivate-user-admin)(L-1611)
    - [❌Assign User Roles (Admin)](#assign-user-roles-admin)(L-1616)
  - [❌Admin Service Management](#admin-service-management)(L-1621)
    - [❌List All Services (Admin)](#list-all-services-admin)(L-1626)
    - [❌Update Service Details (Admin)](#update-service-details-admin)(L-1631)
    - [❌Manage Service Categories (Admin)](#manage-service-categories-admin)(L-1636)
- [❌WebSocket APIs](#websocket-apis)(L-1643)
  - [❌Real-time Notifications (WebSocket)](#real-time-notifications-websocket)(L-1648)
  - [❌Real-time Messaging (WebSocket)](#real-time-messaging-websocket)(L-1653)
  - [❌Real-time Booking Updates (WebSocket)](#real-time-booking-updates-websocket)(L-1660)
- [❌Health Checks](#health-checks)(L-1667)
  - [❌System Health Endpoint](#system-health-endpoint)(L-1672)
  - [❌Database Health Endpoint](#database-health-endpoint)(L-1677)
  - [❌Service Dependency Health Endpoint](#service-dependency-health-endpoint)(L-1682)
- [❌Metrics](#metrics)(L-1689)
  - [❌Prometheus Metrics Endpoint](#prometheus-metrics-endpoint)(L-1694)
